...
echo_and_run cd "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/utilities/roslz4"
...
echo_and_run /usr/bin/env \
    ...
    "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/utilities/roslz4/setup.py" \
     \
    build --build-base "/home/cartermarcelo/ros-workspace/build/drivers/ros_comm/utilities/roslz4" \
    install \
    --root="${DESTDIR-/}" \
