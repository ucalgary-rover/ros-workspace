...
echo_and_run cd "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/utilities/message_filters"
...
echo_and_run /usr/bin/env \
    ...
    "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/utilities/message_filters/setup.py" \
     \
    build --build-base "/home/cartermarcelo/ros-workspace/build/drivers/ros_comm/utilities/message_filters" \
    install \
    --root="${DESTDIR-/}" \
