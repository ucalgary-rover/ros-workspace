...
echo_and_run cd "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosnode"
...
echo_and_run /usr/bin/env \
    ...
    "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosnode/setup.py" \
     \
    build --build-base "/home/cartermarcelo/ros-workspace/build/drivers/ros_comm/tools/rosnode" \
    install \
    --root="${DESTDIR-/}" \
