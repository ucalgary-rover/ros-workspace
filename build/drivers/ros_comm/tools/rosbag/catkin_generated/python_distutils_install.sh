...
echo_and_run cd "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosbag"
...
echo_and_run /usr/bin/env \
    ...
    "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosbag/setup.py" \
     \
    build --build-base "/home/cartermarcelo/ros-workspace/build/drivers/ros_comm/tools/rosbag" \
    install \
    --root="${DESTDIR-/}" \
