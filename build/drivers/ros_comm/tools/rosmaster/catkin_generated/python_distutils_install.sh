...
echo_and_run cd "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosmaster"
...
echo_and_run /usr/bin/env \
    ...
    "/home/cartermarcelo/ros-workspace/src/drivers/ros_comm/tools/rosmaster/setup.py" \
     \
    build --build-base "/home/cartermarcelo/ros-workspace/build/drivers/ros_comm/tools/rosmaster" \
    install \
    --root="${DESTDIR-/}" \
