...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.field1.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.field1.field4.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.field1.field4.combo_field3 = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.field1.field3 = str[start:end].decode('utf-8', 'rosmsg')
      else:
