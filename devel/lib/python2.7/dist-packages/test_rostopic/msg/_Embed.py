...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.arrays.int8_arr))
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.arrays.int32_arr))
      length = len(self.arrays.uint32_arr)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.arrays.uint32_arr))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.simple.str = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.arrays.int8_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.arrays.int32_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.arrays.uint32_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
