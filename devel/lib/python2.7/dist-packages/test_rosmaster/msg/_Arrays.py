...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.int8_arr))
      _x = self.uint8_arr
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.int32_arr))
      length = len(self.uint32_arr)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.uint32_arr))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.int8_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.int32_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.uint32_arr = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.string_arr = []
