...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.int32_array))
      length = len(self.float32_array)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.float32_array))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.caller_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.orig_caller_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.int32_array = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.float32_array = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.time_array = []
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.caller_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
        ...
        if python3:
          val1.orig_caller_id = str[start:end].decode('utf-8', 'rosmsg')
        else:
