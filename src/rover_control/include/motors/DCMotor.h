    ...
    namespace Motors{
        ...
        class DCMotor{
            ...
            public: 
                ...
                DCMotor(const std::string& name, int port, DCMotorLocation location);
                void operator=(const DCMotor& other)=delete;
                //bool operator==(const DCMotor& other);
                DCMotorLocation motor_location() const noexcept;
                ...
                void createException(Rover::Exceptions::DCMotorException& ex, const PhidgetReturnCode& phidgetCode)const noexcept;
